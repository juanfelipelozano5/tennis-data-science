...
memoria de otros notebooks), más un análisis SQL y un dashboard de Power BI:
...
├── dashboard/
│   └── tennis_dashboard.pbix   # dashboard Power BI
...
6. **Abrir el dashboard:** `dashboard/tennis_dashboard.pbix` en Power BI Desktop.
